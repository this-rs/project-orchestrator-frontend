...
import { testTour, mainTour, chatTour, planListTour, planDetailTour, kanbanTour, taskDetailTour } from '@/tutorial/steps'
...
const allTours: Tour[] = [testTour, mainTour, chatTour, planListTour, planDetailTour, kanbanTour, taskDetailTour]
